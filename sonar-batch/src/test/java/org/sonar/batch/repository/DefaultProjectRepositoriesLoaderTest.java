...
public class DefaultProjectRepositoriesLoaderTest {
  ...
  public void passIssuesModeParameter() {
    ...
    verify(wsLoader).loadStream("/scanner/project?key=foo%3F");

    loader.load(PROJECT_KEY, true, null);
    verify(wsLoader).loadStream("/scanner/project?key=foo%3F&issues=true");
  }

  @Test
  public void deserializeResponse() throws IOException {
    MutableBoolean fromCache = new MutableBoolean();
    ProjectRepositories projectRepo = loader.load(PROJECT_KEY, false, fromCache);
