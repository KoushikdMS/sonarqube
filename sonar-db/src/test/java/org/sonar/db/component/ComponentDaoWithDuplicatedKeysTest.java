...
public class ComponentDaoWithDuplicatedKeysTest {
  ...
  public void select_components_having_same_key() {
    ...
    assertThat(underTest.selectComponentsHavingSameKey(db.getSession(), PROJECT_KEY)).hasSize(3);
  }

  @Test
  public void return_nothing() throws Exception {
    assertThat(underTest.selectComponentsHavingSameKey(db.getSession(), PROJECT_KEY)).isEmpty();
  }
